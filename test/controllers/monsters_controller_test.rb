...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference("Monster.count") do
      post monsters_url, params: { monster: { color: @monster.color, height: @monster.height, name: @monster.name, weight: @monster.weight } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { color: @monster.color, height: @monster.height, name: @monster.name, weight: @monster.weight } }
